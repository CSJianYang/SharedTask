...
class Handler(BaseDynaHandler):
    ...
    def initialize(self, context):
        ...
        model_pt_path = "24L_12L.pt:36L_12L.pt"
        ...
        self.cfg = Namespace()
        self.fp16 = False
        self.cfg.generation = OmegaConf.create({'_name': None, 'beam': 2, 'nbest': 1, 'max_len_a': 0.0, 'max_len_b': 512, 'min_len': 1, 'unnormalized': False, 'lenpen': 1.0, 'unkpen': 0.0})
...
def local_test():
    ...
    manifest = {"model": {"serializedFile": "model.pt model.pt"}}
