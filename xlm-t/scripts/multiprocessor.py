...
def parse_args():
    ...
    parser.add_argument('--src-set', '-src-set', type=str,
                        default=r'/home/v-jiaya/RetriveNMT/data/Marcin/shumma/newstest2016-ende.en',
                        help='source file')
    parser.add_argument('--tgt-set', '-tgt-set', type=str,
                        default=r'/home/v-jiaya/RetriveNMT/data/Marcin/shumma/newstest2016-ende.de',
                        help='dest file')
    parser.add_argument('--new-src-set', '-new-src-set', type=str,
                        default=r'/home/v-jiaya/temp-multiprocess/test-2016.en',
                        help='source file')
    parser.add_argument('--new-tgt-set', '-new-tgt-set', type=str,
                        default=r'/home/v-jiaya/temp-multiprocess/test-2016.de',
                        help='dest file')
    parser.add_argument('--temp-dir', '-temp-dir', type=str,
                        default=r'/home/v-jiaya/temp-multiprocess/',
    ...
    def multi_reader(self, filename):
        if not self.debug:
            ...
            for worker_id in range(self.workers):
                results.append(p.apply_async(MPLogExceptions(self.single_reader), args=(filename, worker_id, self.workers)))
            p.close()
            p.join()
            total_lines = []
