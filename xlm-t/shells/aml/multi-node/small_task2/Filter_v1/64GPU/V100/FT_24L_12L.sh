...
LANG_PAIRS="en-id,id-en,en-jv,jv-en,en-ms,ms-en,en-ta,ta-en,en-tl,tl-en,id-ms,jv-id,jv-ms,jv-tl,ms-id,ta-tl,tl-id,tl-ms"
BT_LANG_PAIRS="en-id,en-jv,en-ms,en-ta,en-tl,id-ms,jv-id,jv-ms,jv-tl,ms-id,ta-tl,tl-id,tl-ms"
