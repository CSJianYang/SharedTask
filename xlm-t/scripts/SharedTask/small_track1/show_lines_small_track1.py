...
def parse_args():
    ...
    parser.add_argument('--bitext', '-bitext', type=str,
                        default=r'../results/small_track1_bitext_lines.txt', help='input stream')
    parser.add_argument('--bt', '-bt', type=str,
                        default=r'../results/small_track1_bt_lines.txt', help='input stream')
    parser.add_argument('--parallel-bt', '-parallel-bt', type=str,
                        default=r'../results/small_track1_parallel_bt_lines.txt', help='input stream')
    parser.add_argument('--output', '-output', type=str,
                        default=r'../results/small_track1.txt', help='input stream')
