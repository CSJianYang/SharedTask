...
batchsize=$3
beam=$4
TEST_PIVOT_SHELL=./shells/aml/multi-node/large_task1/deltalm/test/test_aml_devtest_pivot.sh
TEST_DIRECT_SHELL=./shells/aml/multi-node/large_task1/deltalm/test/test_aml_devtest.sh
echo $dir
if [ "$dir" == "e2x" ]; then
    src=en
