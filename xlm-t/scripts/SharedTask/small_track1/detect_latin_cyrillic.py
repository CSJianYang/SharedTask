...
def parse_args():
    ...
    parser.add_argument('--src', '-src', type=str,
                        default=r'/home/v-jiaya/SharedTask/data/thunder/small_task1/download/train/', help='input stream')
    parser.add_argument('--tgt', '-tgt', type=str,
                        default=r'/home/v-jiaya/SharedTask/data/thunder/small_task1/download/train/', help='input stream')
    parser.add_argument('--new-src', '-new-src', type=str,
                        default=r'/home/v-jiaya/SharedTask/data/thunder/small_task1/Filter_v1/train/', help='input stream')
    ...
    if os.path.isdir(args.src) and args.src == args.tgt:
        ...
        for pair in pairs:
            ...
            if src_lang == "sr":
                src_lang = tgt_lang
                tgt_lang = "sr"
                print("Reset sr for the target side !")
