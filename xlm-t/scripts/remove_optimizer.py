...
def parse_args():
    ...
    parser.add_argument('--path', '-path', type=str,
                        default=r'/mnt/input/SharedTask/thunder/small_task2/Filter_v1/model/24L-12L-A100//avg3_18.pt', help='input src')
    parser.add_argument('--new-path', '-new-path', type=str,
                        default=r'/home/v-jiaya/SharedTask/xlm-t/small_track2_24L_12L.pt', help='input src')
