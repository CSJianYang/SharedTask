...
INPUT_DIR=/mnt/input/SharedTask/thunder/MonolingualData/cc100/all_spm_split_10W/
OUTPUT_DIR=/mnt/input/SharedTask/thunder/MonolingualData/cc100/all_spm_split_10W_bt/
mkdir -p $OUTPUT_DIR
src=$1
tgt=$2
beam=$3
