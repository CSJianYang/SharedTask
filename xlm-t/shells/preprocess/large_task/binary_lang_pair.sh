...
for ((INDEX = 0 ; INDEX < $N ; INDEX++ )); do
    TRAIN=/mnt/input/SharedTask/thunder/large_track/data/split${N}/train${INDEX}/
    DATA_BIN=/mnt/input/SharedTask/thunder/large_track/data/split-data-bin${N}/data-bin${INDEX}/
