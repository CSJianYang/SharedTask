...
for ((INDEX = 0 ; INDEX < $N ; INDEX++ )); do
    TRAIN=/mnt/input/SharedTask/thunder/large_track/data/Filter_v1/split${N}/train${INDEX}/
    DATA_BIN=/mnt/input/SharedTask/thunder/large_track/data/Filter_v1/split-data-bin${N}/data-bin${INDEX}/
