...
TEXT=/mnt/input/SharedTask/thunder/small_task1/download/flores101_dataset/dev-code/
SPM_MODEL=/mnt/input/SharedTask/thunder/PretrainedModel/mm100_175M/flores101_mm100_175M/sentencepiece.bpe.model
LANG_PAIRS=/mnt/input/SharedTask/thunder/PretrainedModel/mm100_175M/flores101_mm100_175M/language_pairs.txt
src=$1
tgt=$2
beam=$3
MODEL=$4
...
if [ $evaluation_tok == "spm" ]; then
    cat $FOUT.out | sacrebleu -tok spm $FTGT
else
