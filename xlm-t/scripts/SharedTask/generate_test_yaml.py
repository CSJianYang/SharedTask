...
if __name__ == "__main__":
    cmds = ""
    for lang in LANGS:
        cmd = "- name: test_{}2x\n  sku: G1\n  sku_count: 1\n  command: \n    - bash ./shells/aml/multi-node/large_task/deltalm/test/test_aml_devtest_all.sh 2x /mnt/input/SharedTask/thunder/large_track/data/model/deltalm/FULL-v0/deltalm/A100/lr1e-4/checkpoint3.pt 64 4 {}\n".format(lang, lang)
        cmds += cmd
    print(cmds)
