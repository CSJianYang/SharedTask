...
MODEL=/mnt/input/SharedTask/thunder/small_task1/Filter_v1/model/36L-12L-FT-XY/
...
BT_LANG_PAIRS="en-et,en-hr,en-hu,en-mk,en-sr,et-hr,hr-et,et-hu,hu-et,et-mk,mk-et,et-sr,sr-et,hr-hu,hu-hr,hr-mk,mk-hr,hr-sr,sr-hr,hu-mk,mk-hu,hu-sr,sr-hu,mk-sr,sr-mk"
#BT_LANG_PAIRS="en-et,en-hr,en-hu,en-mk,en-sr,et-hr,hr-et,et-hu,hu-et,et-mk,mk-et,et-sr,sr-et,hr-hu,hu-hr,hr-mk,mk-hr,hr-sr,sr-hr,hu-mk,mk-hu,hu-sr,sr-hu,mk-sr,sr-mk""
...
PARALLEL_BT_LANG_PAIRS="et-en,hr-en,hu-en,mk-en,sr-en"
...
python -m torch.distributed.launch --nproc_per_node=8 --nnodes=8 --node_rank=$OMPI_COMM_WORLD_RANK --master_addr="$MASTER_ADDR" --master_port=$MASTER_PORT train.py $DATA_BIN \
    ...
    --langs $LANGS --data-param-list-sampling-ratios "{\"main\":0.4,\"bt\":0.4,\"parallel_bt\":0.2}" \
    ...
    --max-update 400000 --max-epoch 100 --weight-decay 0.0 --max-tokens 1280 --encoder-layers 36 --update-freq 64 --clip-norm 1.0 \
