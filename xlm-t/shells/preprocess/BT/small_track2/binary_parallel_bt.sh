...
for ((INDEX = $START ; INDEX < $END ; INDEX++ )); do
    TRAIN=/mnt/input/SharedTask/thunder/small_task2/Filter_v1/parallel_bt2.5-split${N}/train${INDEX}/
    DATA_BIN=/mnt/input/SharedTask/thunder/small_task2/Filter_v1/parallel_bt2.5_split-data-bin${N}/data-bin${INDEX}/
