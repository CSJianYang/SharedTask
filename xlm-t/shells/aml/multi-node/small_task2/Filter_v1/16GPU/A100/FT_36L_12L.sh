...
#Parallel BT
PARALLEL_BT_TEXT=/mnt/input/SharedTask/thunder/small_task2/Filter_v1/parallel_bt_split-data-bin10/
...
MODEL=/mnt/input/SharedTask/thunder/small_task2/Filter_v1/model/36L-12L-FT/
