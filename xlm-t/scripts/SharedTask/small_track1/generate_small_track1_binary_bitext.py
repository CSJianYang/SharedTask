...
def parse_args():
    ...
    parser.add_argument('--lang-pairs', '-lang-pairs', type=str,
                        default=r'/mnt/input/SharedTask/thunder/small_task1/Filter_v1/split10/train0/', help='input stream')
...
if __name__ == "__main__":
    ...
    for lang_pair in lang_pairs:
        ...
        cmds += "- name: binary_{}-{}\n  sku: G0\n  sku_count: 1\n  command: \n    - bash ./shells/preprocess/BT/small_track1/binary_bitext.sh {} {} {}\n".format(src, tgt, src, tgt, N)
    print(cmds)